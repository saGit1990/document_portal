...
class DocumentHandler:
    ...
    def __init__(self,data_dir=None,session_id=None):
        try:
            ...
            raise CustomDocumentException("Error initializing DocumentHandler", e) from e
    ...
    def save_pdf(self,uploaded_file):
        try:
            ...
            if not filename.lower().endswith(".pdf"):
                raise CustomDocumentException("Invalid file type. Only PDFs are allowed.")
            ...
            raise CustomDocumentException("Error saving PDF", e) from e
