...
class DocumentIngestion:
    ...
    def delete_existing_files(self):
        ...
        try:
            ...
            raise CustomDocumentException("An error occurred while deleting existing files.", sys)
    ...
    def save_uploaded_files(self,reference_file, actual_file):
        ...
        try:
            ...
            raise CustomDocumentException("An error occurred while saving uploaded files.", sys)
    ...
    def read_pdf(self,pdf_path: Path)->str:
        ...
        try:
            ...
            raise CustomDocumentException("An error occurred while reading the PDF.", sys)
    ...
    def combine_documents(self)->str:
        try:
            ...
            raise CustomDocumentException("An error occurred while combining documents.", sys)