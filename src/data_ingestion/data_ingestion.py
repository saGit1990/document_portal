...
class ChatIngestor:
    def __init__( self,
        ...
        try:
            ...
            raise CustomDocumentException("Initialization error in ChatIngestor", e) from e
...
class DocHandler:
    ...
    def save_pdf(self, uploaded_file) -> str:
        try:
            ...
            raise CustomDocumentException(f"Failed to save PDF: {str(e)}", e) from e
...
class DocumentComparator:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        try:
            ...
            raise CustomDocumentException("Error saving files", e) from e
    ...
    def read_pdf(self, pdf_path: Path) -> str:
        try:
            ...
            raise CustomDocumentException("Error reading PDF", e) from e
    ...
    def combine_documents(self) -> str:
        try:
            ...
            raise CustomDocumentException("Error combining documents", e) from e
